...
class handDetector:
    def __init__(self, mode=False, maxHands=2, detectionCon=0.5, trackCon=0.5):
        ...
        self.tipIds = [4, 8, 12, 16, 20]  # Thumb and fingertips for detection
    ...
    def fingersUp(self):
        """Return list indicating which fingers are up."""
        fingers = []
    ...
    def findDistance(self, p1, p2, img, draw=True, r=15, t=3):
        """Calculate and optionally draw the distance between two points."""
...
def main():
    ...
    while True:
        ...
        if len(lmList) != 0:
            print(lmList[4])  # Thumb tip coordinates
